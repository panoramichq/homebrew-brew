class PanoramicCliAT171 < Formula
  include Language::Python::Virtualenv

  desc "Panoramic Command Line Interface"
  homepage "https://github.com/panoramichq/panoramic-cli"
  url "https://files.pythonhosted.org/packages/77/91/a85e72ba8e6512d3109b00cfbd63527be2746ddbbe4e6d383dca0945e8a4/panoramic-cli-1.7.1.tar.gz"
