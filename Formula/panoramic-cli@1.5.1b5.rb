class PanoramicCliAT151b5 < Formula
  include Language::Python::Virtualenv

  desc "Panoramic Command Line Interface"
  homepage "https://github.com/panoramichq/panoramic-cli"
  url "https://files.pythonhosted.org/packages/88/83/7a8ba1cd12a39e1034ee0cdeef747c0211cabeafed017b40f5692c4b2359/panoramic-cli-1.5.1b5.tar.gz"
  sha256 "55882b954110a56b21a435413adb653f3d1bb9972a8419d595fcb756298a3392"

  bottle do
    root_url "https://a1.panocdn.com/bottles"
    sha256 "025c462efb95dc0f0674703c9d737ec9829e09c31dddc72c171c78bc8ec671b2" => :big_sur
    sha256 "52adc1b4f25d37d831523874632e7ad34618216709bcf0e3568e0b2487871cd2" => :catalina
  end
